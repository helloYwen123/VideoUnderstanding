...
mkdir ../data/hourvideo
# mkdir ../data/nextqa
# mkdir ../data/intentqa
# mkdir ../data/activitynet
# TODO add more datasets here
# link the data
ln -s ../../egoschema/* ../data/egoschema/
...
ln -s ../../lavila/modelzoo/* ../toolbox/lavila_video_captioner/modelzoo/
...
# TODO make sure to change the path to the model checkpoints depending on your download location
ln -s ../../UniVTG/pretrained/* ../toolbox/UniVTG/results/omni/pretrained/
ln -s ../../UniVTG/finetuned/* ../toolbox/UniVTG/results/omni/finetuned/
